<template>
  <div class="user-avatar" :style="{ width: size + 'px', height: size + 'px' }">
    <img
      ...
      @error="imgError = true"
    />
    <svg v-else viewBox="0 0 24 24" fill="none" class="avatar-default">
      <circle cx="12" cy="8" r="3.5" stroke="currentColor" stroke-width="1.5"/>
      <path d="M4.5 19.5C4.5 16.186 7.186 13.5 10.5 13.5h3c3.314 0 6 2.686 6 6"
...
.avatar-default { width: 60%; height: 60%; }
</style>
